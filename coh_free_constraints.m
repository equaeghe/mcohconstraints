function coh_free_constraints(K, filename, numbertype)
% COH_FREE_CONSTRAINTS  writes the 'free' constraints for avoiding sure loss to a file
%
% Synopsis:
%    asl_free_constraints(K, filename, numbertype)
%
% Input:
...
%
% Background & Method: ***TO BE FULLY ADAPTED TO COH-case***

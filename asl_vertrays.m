...
% ASL_VERTRAYS  writes the vertices and extreme rays for avoiding sure loss to a file
%
% Synopsis:
...
%    it belongs to the polyhedron defined by the degenerate previsions as
%    vertices and negative directions as extreme rays. These are written out to
%    a file in 'Polyhedra V format'. This format can be read by polytpe theory
%    programs such as cddlib and lrs, for example, to compute the facet or
